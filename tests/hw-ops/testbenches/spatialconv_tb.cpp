...
int main() {
  ...
  if (K == 5) {
    float c[K][K] = {{0.003663003, 0.01465201465, 0.02564102564, 0.01465201465, 0.003663003}, 
    ...
    float c[K][K] = {{0, 0, 0.000997008, 0.001994017, 0.000997008, 0, 0}, 
    ...
    float c[K][K] = {{0.0625, 0.125, 0.0625}, 
                     {0.125, 0.25, 0.125}, 
                     {0.0625, 0.125, 0.0625}};
  }
