...
template <typename T, int K, int O, class ADD, class MULT>
template <int M1, int N, int N2>
inline void Winograd5<T, K, O, ADD, MULT>::MatMultiply(
...
inline void Winograd5<T, K, O, ADD, MULT>::DetransformOutput(
  ...
  T At[kAtRows][kAtCols] = {{1,1,1,1,1,0}, {0,1,-1,2,-2,1}};
  T A[kAtCols][kAtRows] = {{1, 0}, {1, 1}, {1, -1}, {1, 2}, {1, -2}, {0, 1}};
...
inline void Winograd5<T, K, O, ADD, MULT>::TransformKernel(
  ...
  T G[kGRows][kGCols] = {
    ...
    {0     , 0     ,0    ,     0,1}};
  T Gt[kGCols][kGRows] = {
    {0.25,-0.167,-0.167,0.0417,0.0417,0},
